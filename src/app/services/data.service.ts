...
export class DataService {
  ...
  ArabaListele() {
    return this.http.get<Araba[]>(this.apiUrl + 'cars');
  }
  ArabaListeleByKatId(katId: number) {
    return this.http.get<Araba[]>(
      this.apiUrl + 'categories/' + katId + '/cars'
    );
  }
  ArabaById(id: number) {
    return this.http.get<Araba>(this.apiUrl + 'cars/' + id);
  }
  ArabaEkle(araba: Araba) {
    return this.http.post(this.apiUrl + 'cars/', araba);
  }
  ArabaDuzenle(araba: Araba) {
    return this.http.put(this.apiUrl + 'cars/' + araba.id, araba);
  }
  ArabaSil(id: number) {
